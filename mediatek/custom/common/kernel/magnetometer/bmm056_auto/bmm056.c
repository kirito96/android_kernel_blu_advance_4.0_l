...
static struct sensor_init_info bmm050_init_info = {
		.name = "bmm050",
...
static int bmm050_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	data->hw = bmm050_get_cust_mag_hw();	
...
static int bmm050_probe(struct platform_device *pdev) 
{
	struct mag_hw *hw = bmm050_get_cust_mag_hw();
	MSE_FUN();
...
static int bmm050_remove(void)
{
	...
	MSE_FUN();
	bmm050_power(hw, 0); 
	i2c_del_driver(&(bmm050_init_info.platform_diver_addr->driver));
	return 0;
}
/*----------------------------------------------------------------------------*/
static int	bmm050_local_init(void)
...
static int __init bmm050_init(void)
{
	...
	hwmsen_msensor_add(&bmm050_init_info);
	return 0;    
}
/*----------------------------------------------------------------------------*/
