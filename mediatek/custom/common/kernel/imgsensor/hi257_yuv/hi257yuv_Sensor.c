...
UINT32 HI257Open(void)
{
  ...
  //      SensorId = HI257_SENSOR_ID; 
    ...
    {
	//yixuhong delete temp MainCameraDigtalPDNCtrl(1);
  }
  HI257InitSetting();
  HI257InitPara();
  return ERROR_NONE;
...
{   HI257WriteCmosSensor(0x03, 0x10);//very dark mode
	...
	HI257WriteCmosSensor(0x6a, 0x58);
	//HI257SetPage(0x22);  
    //HI257WriteCmosSensor(0x82,(HI257ReadCmosSensor(0x82)-0));//make sure the Yoffset control is opened.
    CapShutter = HI257Status.PvShutter;
}
...
HI257WriteCmosSensor(0x61, 0xa8); //Sat B
