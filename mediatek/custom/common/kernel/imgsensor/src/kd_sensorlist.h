...
UINT32 SP0A19_MAIN_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//yixuhong 20140318 add sp0a19_yuv back camera
...
//yixuhong add tinno camera start
    ...
    {SP0A19_MAIN_SENSOR_ID, SENSOR_DRVNAME_SP0A19_MAIN_YUV, SP0A19_MAIN_YUV_SensorInit}, 
#endif
