...
u8 cfg_info_group6_null[] = 
{
    ...
    u8 *send_cfg_buf[] = {cfg_info_group1_dijing, cfg_info_group2_shenyue, cfg_info_group3_jtouch,
                        cfg_info_group4_null, cfg_info_group5_null, cfg_info_group6_null};
    u8 cfg_info_len[] = { CFG_GROUP_LEN(cfg_info_group1_dijing), 
                          CFG_GROUP_LEN(cfg_info_group2_shenyue),
                          CFG_GROUP_LEN(cfg_info_group3_jtouch),
                          CFG_GROUP_LEN(cfg_info_group4_null), 
                          CFG_GROUP_LEN(cfg_info_group5_null),
                          CFG_GROUP_LEN(cfg_info_group6_null)};
...
GTP_INFO("Gt9xx_tpd_get_fw_vendor_name lishengli555  : tpd_info.sid =  %d",
    ...
    switch(tpd_info.sid)
    {
        ...
        case 2:
            sprintf(fw_vendor_name, "jiemian + %d", cfg_vs);
            break;
