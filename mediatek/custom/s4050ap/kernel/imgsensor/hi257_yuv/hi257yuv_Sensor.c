...
HI257WriteCmosSensor(0x41, 0x02); //D-YOffset Th
...
HI257WriteCmosSensor(0x50, 0x90); //D-YOffset AG

HI257WriteCmosSensor(0x60, 0x4f); //Outdoor Saturation
HI257WriteCmosSensor(0x61, 0xa5); //Sat B
...
HI257WriteCmosSensor(0xa5, 0x04); //Indoor Lclip_P 0x0f For reso Limit 0x0f
HI257WriteCmosSensor(0xa6, 0x10); //Dark Lclip_N
HI257WriteCmosSensor(0xa7, 0x10); //Dark Lclip_P
...
HI257WriteCmosSensor(0x23, 0x13); //LSC G
HI257WriteCmosSensor(0x24, 0x13); //LSC B
...
HI257WriteCmosSensor(0x15, 0x42);	//CMCOFSGM
HI257WriteCmosSensor(0x16, 0x32);	//CMCOFSGL
HI257WriteCmosSensor(0x17, 0x2f);	//CMC SIGN
//CMC
HI257WriteCmosSensor(0x30, 0x8f);
HI257WriteCmosSensor(0x31, 0x75);
HI257WriteCmosSensor(0x32, 0x26);
...
HI257WriteCmosSensor(0x18, 0x77);// Double_AG 5e->37
HI257WriteCmosSensor(0x19, 0x76);// Double_AG 5e->36
...
HI257WriteCmosSensor(0x22, 0x40); //mcmc_sat_gain5
HI257WriteCmosSensor(0x23, 0x37); //mcmc_sat_gain6
HI257WriteCmosSensor(0x24, 0x00); //mcmc_hue_angle1
HI257WriteCmosSensor(0x25, 0x02); //mcmc_hue_angle2
...
HI257WriteCmosSensor(0xb1, 0x15);
...
HI257WriteCmosSensor(0x20, 0x33);
HI257WriteCmosSensor(0x21, 0x33);
HI257WriteCmosSensor(0x22, 0x33);
HI257WriteCmosSensor(0x23, 0x33);
HI257WriteCmosSensor(0x24, 0x33);
HI257WriteCmosSensor(0x25, 0x33);
HI257WriteCmosSensor(0x26, 0x33);
HI257WriteCmosSensor(0x27, 0x33);
HI257WriteCmosSensor(0x28, 0x33);
HI257WriteCmosSensor(0x29, 0x77);
HI257WriteCmosSensor(0x2a, 0x77);
HI257WriteCmosSensor(0x2b, 0x33);
HI257WriteCmosSensor(0x2c, 0x33);
HI257WriteCmosSensor(0x2d, 0x77);
HI257WriteCmosSensor(0x2e, 0x77);
HI257WriteCmosSensor(0x2f, 0x33);
HI257WriteCmosSensor(0x30, 0x33);
HI257WriteCmosSensor(0x31, 0x77);
HI257WriteCmosSensor(0x32, 0x77);
HI257WriteCmosSensor(0x33, 0x33);
HI257WriteCmosSensor(0x34, 0x33);
HI257WriteCmosSensor(0x35, 0x77);
HI257WriteCmosSensor(0x36, 0x77);
HI257WriteCmosSensor(0x37, 0x33);
HI257WriteCmosSensor(0x38, 0x33);
HI257WriteCmosSensor(0x39, 0x33);
HI257WriteCmosSensor(0x3a, 0x33);
HI257WriteCmosSensor(0x3b, 0x33);
HI257WriteCmosSensor(0x3c, 0x33);
HI257WriteCmosSensor(0x3d, 0x33);
HI257WriteCmosSensor(0x3e, 0x33);
HI257WriteCmosSensor(0x3f, 0x33);
HI257WriteCmosSensor(0x40, 0x33);
HI257WriteCmosSensor(0x41, 0x33);
HI257WriteCmosSensor(0x42, 0x33);
HI257WriteCmosSensor(0x43, 0x33);
HI257WriteCmosSensor(0x44, 0x33);
HI257WriteCmosSensor(0x45, 0x33);
HI257WriteCmosSensor(0x46, 0x33);
HI257WriteCmosSensor(0x47, 0x33);
HI257WriteCmosSensor(0x48, 0x33);
HI257WriteCmosSensor(0x49, 0x77);
HI257WriteCmosSensor(0x4a, 0x77);
HI257WriteCmosSensor(0x4b, 0x33);
HI257WriteCmosSensor(0x4c, 0x33);
HI257WriteCmosSensor(0x4d, 0x77);
HI257WriteCmosSensor(0x4e, 0x77);
HI257WriteCmosSensor(0x4f, 0x33);
HI257WriteCmosSensor(0x50, 0x33);
HI257WriteCmosSensor(0x51, 0x77);
HI257WriteCmosSensor(0x52, 0x77);
HI257WriteCmosSensor(0x53, 0x33);
HI257WriteCmosSensor(0x54, 0x33);
HI257WriteCmosSensor(0x55, 0x77);
HI257WriteCmosSensor(0x56, 0x77);
HI257WriteCmosSensor(0x57, 0x33);
HI257WriteCmosSensor(0x58, 0x33);
HI257WriteCmosSensor(0x59, 0x33);
HI257WriteCmosSensor(0x5a, 0x33);
HI257WriteCmosSensor(0x5b, 0x33);
HI257WriteCmosSensor(0x5c, 0x33);
HI257WriteCmosSensor(0x5d, 0x33);
HI257WriteCmosSensor(0x5e, 0x33);
HI257WriteCmosSensor(0x5f, 0x33);
...
HI257WriteCmosSensor(0x20, 0x30);
HI257WriteCmosSensor(0x21, 0x80);
HI257WriteCmosSensor(0x22, 0x00);
HI257WriteCmosSensor(0x23, 0x00);
HI257WriteCmosSensor(0x24, 0x01);
HI257WriteCmosSensor(0x30, 0x7e);
HI257WriteCmosSensor(0x31, 0x80);
HI257WriteCmosSensor(0x38, 0x11);
HI257WriteCmosSensor(0x39, 0x34);
HI257WriteCmosSensor(0x3a, 0x88);
HI257WriteCmosSensor(0x3b, 0xc4);
HI257WriteCmosSensor(0x40, 0xe4);
HI257WriteCmosSensor(0x41, 0x33);
HI257WriteCmosSensor(0x42, 0x22);
HI257WriteCmosSensor(0x43, 0xf3);
HI257WriteCmosSensor(0x44, 0x55);
HI257WriteCmosSensor(0x45, 0x33);
...
HI257WriteCmosSensor(0x8f, 0x4d);
HI257WriteCmosSensor(0x90, 0x46);
HI257WriteCmosSensor(0x91, 0x40);
HI257WriteCmosSensor(0x92, 0x3a);
HI257WriteCmosSensor(0x93, 0x2f);
...
HI257WriteCmosSensor(0xa4, 0x14);
HI257WriteCmosSensor(0xa5, 0x2c);
HI257WriteCmosSensor(0xa6, 0xcf);
HI257WriteCmosSensor(0xad, 0x2e);
HI257WriteCmosSensor(0xae, 0x2a);
HI257WriteCmosSensor(0xaf, 0x28);
HI257WriteCmosSensor(0xb0, 0x26);
HI257WriteCmosSensor(0xb1, 0x08);
HI257WriteCmosSensor(0xb2, 0x48);
HI257WriteCmosSensor(0xb3, 0x40);
HI257WriteCmosSensor(0xd2, 0x80);
HI257WriteCmosSensor(0xd3, 0x7f);
/////// PAGE 22 END ///////
...

{
	...
	HI257WriteCmosSensor(0x18, 0x38);
		...
		HI257WriteCmosSensor(0x83, 0x18);  //EXP Normal 8.33 fps 
		HI257WriteCmosSensor(0x84, 0xcb); 
		HI257WriteCmosSensor(0x85, 0xa8); 

	HI257WriteCmosSensor(0x86, 0x01); //EXPMin 13000.00 fps*2 by paul
	HI257WriteCmosSensor(0x87, 0xf4); 


		HI257WriteCmosSensor(0x88, 0x18); //EXP Max(120Hz) 8.00 fps 
		HI257WriteCmosSensor(0x89, 0xb8); 
		HI257WriteCmosSensor(0x8a, 0x20); 

		HI257WriteCmosSensor(0xa5, 0x18); //EXP Max(100Hz) 8.33 fps   
		HI257WriteCmosSensor(0xa6, 0xcb); 
		HI257WriteCmosSensor(0xa7, 0x18);  
...

{
	...
	HI257WriteCmosSensor(0x18, 0x38);
		...
		HI257WriteCmosSensor(0x83, 0x18);   //EXP Normal 5.00 fps 
		HI257WriteCmosSensor(0x84, 0xb8); 
		HI257WriteCmosSensor(0x85, 0x20); 

		HI257WriteCmosSensor(0x86, 0x01); //EXPMin 13000.00 fps*2 by paul
		HI257WriteCmosSensor(0x87, 0xf4); 

		HI257WriteCmosSensor(0x88, 0x18); //EXP Max(120Hz) 5.00 fps 
		HI257WriteCmosSensor(0x89, 0xb8); 
		HI257WriteCmosSensor(0x8a, 0x20); 

		HI257WriteCmosSensor(0xa5, 0x18); //EXP Max(100Hz) 5.00 fps 
		HI257WriteCmosSensor(0xa6, 0xcb); 
		HI257WriteCmosSensor(0xa7, 0xa8);  
...
HI257WriteCmosSensor(0xb7, 0x46); //Lum negative middle
HI257WriteCmosSensor(0xb8, 0x46); //Lum negative Low
HI257WriteCmosSensor(0xb9, 0x35); //Lum postive Hi
HI257WriteCmosSensor(0xba, 0x35); //Lum postive middle
HI257WriteCmosSensor(0xbb, 0x42); //Lum postive Low

//Indoor Slope
HI257WriteCmosSensor(0xbc, 0x40); //Lum negative Hi
HI257WriteCmosSensor(0xbd, 0x45); //Lum negative middle
HI257WriteCmosSensor(0xbe, 0x30); //Lum negative Low
HI257WriteCmosSensor(0xbf, 0x40); //Lum postive Hi
HI257WriteCmosSensor(0xc0, 0x45); //Lum postive middle
HI257WriteCmosSensor(0xc1, 0x30); //Lum postive Low
...
{  
  ...
  {
if(Ymean<0x5)//flash capture dark
...
{   HI257WriteCmosSensor(0x03, 0x10);//very dark mode
	...
	//HI257WriteCmosSensor(0x22, 0x24); //LSC R 1b->15 20130125
	//HI257WriteCmosSensor(0x23, 0x22); //LSC G
	//HI257WriteCmosSensor(0x24, 0x22); //LSC B
		Flash_FLAG = 0;
		if(AG>0x25)
		{

	 HI257SetPage(0x20);
	 HI257WriteCmosSensor(0xb0,(HI257ReadCmosSensor(0xb0)-8));//make sure the Yoffset control is opened.   
			}

}

else//flash capture bright
    { 
...
{
	 HI257SetPage(0x20);
	 HI257WriteCmosSensor(0xb0,(HI257ReadCmosSensor(0xb0)-15));//make sure the Yoffset control is opened.   
}
...
HI257WriteCmosSensor(0x61, 0xa5); //Sat B
HI257WriteCmosSensor(0x62, 0xb0); //Sat R
HI257WriteCmosSensor(0x63, 0xb0); //Auto-De Color
...
spin_unlock(&hi257_drv_lock);
SENSORDB("[HI257]HI257SetBanding AE_FLICKER_MODE_OFF \n");
