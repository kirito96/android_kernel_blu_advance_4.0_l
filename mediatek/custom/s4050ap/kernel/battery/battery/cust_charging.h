...
#define MAX_CHARGE_TEMPERATURE  60 //61
#define MAX_CHARGE_TEMPERATURE_MINUS_X_DEGREE	58//60
#define MIN_CHARGE_TEMPERATURE   0 //-14
#define MIN_CHARGE_TEMPERATURE_PLUS_X_DEGREE	2 //-11
