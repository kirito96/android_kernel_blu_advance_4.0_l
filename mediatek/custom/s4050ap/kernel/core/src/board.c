...
#define MSDC_SDCARD_FLAG  (MSDC_SYS_SUSPEND | MSDC_REMOVABLE | MSDC_HIGHSPEED | MSDC_CD_PIN_EN | MSDC_REMOVABLE )
#define MSDC_EMMC_FLAG	  (MSDC_SYS_SUSPEND | MSDC_HIGHSPEED)//| MSDC_CD_PIN_EN | MSDC_REMOVABLE 
#else
#define MSDC_SDCARD_FLAG  (MSDC_SYS_SUSPEND | MSDC_HIGHSPEED| MSDC_UHS1 |MSDC_DDR | MSDC_CD_PIN_EN | MSDC_REMOVABLE )
